        ...
        <header className="header heightJs">
            <div className="header_container">
                ...
                <nav className="header_container-nav">
                    <a href="#about" className="bouton bouton_link header_container-nav--link">About</a>
                    <a href="#skills" className="bouton bouton_link header_container-nav--link">Skills</a>
                    <a href="#projects" className="bouton bouton_link header_container-nav--link">Projects</a>
                    <a href="#contact" className="bouton bouton_link header_container-nav--link">Contact</a>
                    <div className="burgerMenu">
                        <div className="burgerMenu_barre"></div>
                    </div>
                </nav>
            </div>    

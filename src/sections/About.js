                    ...
                    <div className="about_sticky-container-bloc">
                        <div className="bloc">
                            ...
                            <figure className="bloc_img">
                                ...
                                <img src={RubberWebStarOne} className="bloc_img-starOne apparition2" alt="Rubber Hose Web"/>
                                <img src={RubberWebStarTwo} className="bloc_img-starTwo apparition3" alt="Rubber Hose Web"/>

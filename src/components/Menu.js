...
const OpenMenu = () => {
    ...
    return (
        <section className={`menu heightJs ${menuOpen ? 'active' : ''}`}>
            ...
            <div className="menu_rs">
                <p>Réseaux sociaux</p>
                <div className="menu_rs-bloc">
                    <a href="https://github.com/mathoos" className="menu_rs-bloc--icon" target="_blank" rel="noreferrer" aria-label="Profil GitHub">
                        <div className="bulle">
                    ...
                    <a href="https://www.instagram.com/matho_os/" className="menu_rs-bloc--icon" target="_blank" rel="noreferrer" aria-label="Profil Instagram">
                        <div className="bulle">
                    ...
                    <a href="https://www.linkedin.com/in/mathildebret/" className="menu_rs-bloc--icon" target="_blank" rel="noreferrer" aria-label="Profil LinkedIn">
                        <div className="bulle">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">

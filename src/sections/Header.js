        ...
        <header className="header">
            <div className="header_content heightJs">
                ...
                <div className="rs">
                    ...
                    <a href="https://www.instagram.com/matho_os/" className="rs_icon" target="_blank" rel="noreferrer" aria-label="Profil Instagram">
                        <div className="rs_icon-bulle">
                    ...
                    <a href="https://www.linkedin.com/in/mathildebret/" className="rs_icon" target="_blank" rel="noreferrer" aria-label="Profil LinkedIn">
                        <div className="rs_icon-bulle">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
